...
class EyesUtil {
     ...
     */
    open(testDesc, testName, isDebug, boundingBoxObj) {
        Reporter_1.Reporter.debug(`Set Debug Mode ${isDebug}`);
     ...
     */
    setEyeDebugMode(isDebug) {
        if (isDebug) {
            browser.call(() => {
                return this.eyes.setLogHandler(new eyes_sdk_core_1.FileLogHandler(isDebug));
            });
        }
        return this;
    }
