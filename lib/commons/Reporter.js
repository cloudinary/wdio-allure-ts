...
(function (Reporter) {
     ...
     */
    function enableNetworkAudits() {
        if (browser.capabilities.browserName === 'chrome') {
            // @ts-ignore
            browser.cdp('Network', 'enable');
            networkActivity.push({ url: 'URL', status: 'STATUS', headers: { someData: 'HEADERS' } });
            // @ts-ignore
    ...
    Reporter.enableNetworkAudits = enableNetworkAudits;
    function attachAndComposeNetworkLogs() {
        // @ts-ignore
