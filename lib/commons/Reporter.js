...
(function (Reporter) {
    ...
    function clearNetworkActivityArray() {
     ...
     */
    function closeStep(isFailed = false) {
        if (isFailed) {
     ...
     */
    function sendCustomCommand(command, stepStatus = 'passed') {
        const stepContent = {
            content: command.body,
            name: command.bodyLabel,
        };
        allure_reporter_1.default.addStep(command.title, stepContent, stepStatus);
    }
