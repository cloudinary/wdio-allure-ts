...
(function (BrowserUtils) {
     ...
     */
    function setWindowSize(requestedWidth, requestedHeight) {
        ...
        Reporter_1.Reporter.debug(`size >> ${JSON.stringify(size)}`);
