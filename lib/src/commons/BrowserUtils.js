...
(function (BrowserUtils) {
    ...
    function switchTab(tabId) {
        ...
        Reporter_1.Reporter.debug(`SUCCESS: Switching tab to [${tabId}]`);
    }
    ...
    function scrollToElement(elementSelector, listSelector) {
        Reporter_1.Reporter.debug('');
        Reporter_1.Reporter.debug(`Scroll in list [${listSelector}] until element [${elementSelector} ] is visible.`);
        ...
        Reporter_1.Reporter.debug('SUCCESS: Scroll to element.');
        Reporter_1.Reporter.debug('');
    }
