...
(function (BrowserUtils) {
     ...
     */
    function isDisabled(selector, expectedToBe = false) {
        Reporter_1.Reporter.debug(`Wait for an element to be enabled or disabled '${selector}'`);
        isExist(selector);
        const element = $(selector);
        return element.waitForEnabled(DEFAULT_TIME_OUT, expectedToBe);
    }
    BrowserUtils.isDisabled = isDisabled;
    /**
