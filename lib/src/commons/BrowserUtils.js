...
(function (BrowserUtils) {
    ...
    function scrollIntoView(selector) {
        ...
        tryBlock(() => $(selector).scrollIntoView(), `Failed to scroll to element: [${selector}]`);
    }
    ...
    function hover(selector) {
        ...
        isDisplayed(selector);
        tryBlock(() => $(selector).moveTo(), `Failed to hover over '${selector}' at location '${JSON.stringify(location)}'`);
    }
     ...
     * @param selector selector of an element to hover
     */
    function hoverOverElementLocation(selector) {
        Reporter_1.Reporter.debug(`Move to an element '${selector}'`);
        isDisplayed(selector);
    ...
    BrowserUtils.hoverOverElementLocation = hoverOverElementLocation;
    /**
