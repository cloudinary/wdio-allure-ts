...
(function (BrowserUtils) {
     ...
     */
    function expectAlertOpened() {
        Reporter_1.Reporter.debug('Validate alert opened');
        tryBlock(() => browser.waitUntil(() => browser.isAlertOpen()), 'Alert not found');
    }
    BrowserUtils.expectAlertOpened = expectAlertOpened;
    /**
     * Validate alert closed
     */
    function expectAlertClosed() {
        Reporter_1.Reporter.debug('Validate alert opened');
        tryBlock(() => browser.waitUntil(() => !browser.isAlertOpen()), 'Alert found');
    }
    BrowserUtils.expectAlertClosed = expectAlertClosed;
    /**
     * Accept Alert popup
     */
