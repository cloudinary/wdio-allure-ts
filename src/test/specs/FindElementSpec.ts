...
describeCommon('findElement of BrowserUtils Tests', () => {
  it('Check Result contains element key (object)', () => {
    Reporter.step('Validate return value of find element');
  ...
  it('Fail to obtain element due to wrong path', () => {
    Reporter.step('Find element by wrong selector');
  ...
  it('First Element Returned', () => {
    Reporter.step('Validate first element returned in case of multiple match');
